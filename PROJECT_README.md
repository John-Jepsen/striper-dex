...
git clone https://github.com/yourusername/bay-water-temps
cd bay-water-temps
make build
make pipeline
python scripts/generate_research_artifacts.py
...
This is academic research code. For questions or collaborations:

1. Open an issue describing your interest
2. For bugs, include minimal reproducible example
3. For enhancements, explain scientific rationale
...
```bibtex
@article{monterey_fishing_prediction_2024,
  title={Predicting Optimal Fishing Conditions in Monterey Bay: A Machine Learning Approach},
  author={[Your Name]},
  journal={[Journal/Conference]},
  year={2024},
  note={Available at: https://github.com/yourusername/bay-water-temps}
}
```
...
1. Miller et al. (2019) - Commercial tuna forecasting
2. Hobday & Hartmann (2006) - Habitat-based prediction
3. Hazen et al. (2018) - Dynamic ocean management
